...
# %% auto #0
__all__ = ['find_dyalog', 'start_dyalog', 'ride_send', 'ride_recv', 'AplError', 'AplPrompt', 'ride_run', 'Apl', 'APLMagic',
           'create_magic', 'load_ipython_extension', 'create_ipython_config']
...
class APLMagic:
    ...
    def apl(self, line, cell=None):
        ...
        if not self._loaded:
            ...
            self._loaded = True
        if cell is None: return self.o.pyval(line.split('⍝')[0].strip())
